...
def linprog_from_array(array: Sequence[Sequence[SupportsNumberType]], obj_type: LPObjType) -> LinProg: ...
...
def matrix_rank(mat: Matrix, ignored_rows: Container[int] = (), ignored_cols: Container[int] = ()) -> tuple[Set[int], Set[int], int]: ...
def matrix_weak_adjacency(mat: Matrix) -> Sequence[Set[int]]: ...
def polyhedron_from_matrix(mat: Matrix, row_order: Optional[RowOrderType] = None) -> Polyhedron: ...
def redundant(mat: Matrix, row: int, strong: bool = False) -> tuple[bool, Sequence[NumberType]]: ...
